...
class GameEntity(Entity):
    ...
    def __repr__(self):
        return f"['{self.__class__.__name__}',{self.position},{self.collider.radius},{self.rotation},{self.team},{self.score},{self.eliminations},{self.deaths},{self.hp},{self.next_attack_timestamps},{int(self.can_move)},{int(self.can_attack)}]"
